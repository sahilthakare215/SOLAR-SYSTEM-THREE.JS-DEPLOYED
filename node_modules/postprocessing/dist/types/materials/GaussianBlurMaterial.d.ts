 ...
 * @category Materials
 */
export declare class GaussianBlurMaterial extends FullscreenMaterial implements GaussianBlurMaterialOptions {
    /**
     * @see {@link kernelSize}
     */
    private _kernelSize;
     ...
     */
    constructor({ kernelSize }?: GaussianBlurMaterialOptions);
